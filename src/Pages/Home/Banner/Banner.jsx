                    ...
                    <div className='flex lg:flex-row flex-col-reverse gap-5 items-center lg:h-[640px] h-full'>
                        <div className='lg:w-4/5 lg:mb-0 mb-10'>
                            ...
                            <a href={resume} download="Shahadat's_Resume_for_Front-end_Web_Developer.pdf">
                                <button className='bg-[#ED5671] mt-5 text-white rounded-md px-7 lg:py-3 py-2 font-bold text-md'>Download CV</button>
                            </a>
                            <button className='hover:bg-[#ED5671] border border-[#ED5671] mt-5 text-white rounded-md px-7 lg:py-3 py-2 font-bold text-md ml-5'>Hire Me</button>
                        </div>
                        <div>
